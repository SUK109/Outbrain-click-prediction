...
events <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/events.csv", nrows = 1000000, header = TRUE,sep = ",")
page_views_sample <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/page_views_sample.csv", header=TRUE, nrows = 1000000, sep = ",")
clicks_train <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/clicks_train.csv",nrows = 1000000, header=TRUE, sep =  ",")
clicks_test <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/sample_submission.csv", header=TRUE, nrows = 1000000, sep = ",")
promoted_content <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/promoted_content.csv", header=TRUE, nrows = 1000000, sep = ",")
document_entities <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/documents_entities.csv", header=TRUE, nrows = 1000000, sep = ",")
document_topics <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/documents_topics.csv", header=TRUE, nrows = 1000000, sep = ",")
document_categories <- read.table(file="C:/Users/Adit/Downloads/Outbrain_click_prediction/documents_categories.csv", header=TRUE, nrows = 1000000, sep = ",")
